        ...
        <div class="container rounded">
            ...
            <div id="chat_box container" class="main-bg">
                ...
                <section id="chatRoom" style="height: 350px;">
                    <div class="my-3 p-3 bg-white rounded box-shadow" id="allMessage" data-username="<?php echo $fulInfo[2]; ?>" data-dname="<?php echo test_input($_GET['id']); ?>">
    ...
    <?php include("./includes/footer.php"); ?>
     ...
     <script>
        ...
        $(document).ready(function () {
            ...
            $.post("chatApp/chat.php", function (data) {
                scroll();
                data = $.parseJSON(data);
                var message = "";
        ...
        function send() {
            if(text.val().trim().length > 0){
                var allData = {name : allMessages.data("username"), message: text.val(), dname: allMessages.data("dname")};
