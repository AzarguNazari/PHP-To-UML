            ...
            <div class="container">
                ...
                <div class="row" id="communityList">
                    ...
                    if (isset($_GET["search"])) {
                        ...
                        $result = query("select * from communities order by c_rate DESC limit 8");
                    ...
                    function printResult($row){
                         return '<div class="col-md-3 communityDoor">
                                    <div class="card mb-4 box-shadow bg-dark text-white community" data-cid="'. $row["c_id"] .'">
                                        <div class="card-header text-center border-white">
                                            <h3><a class="text-white communityName" href="community.php?id=' . $row["c_id"] . '">' . $row["c_name"] . '</a></h3>
                                            <h5>' . stars(round($row["c_rate"])) . '</h5>
                                        </div>
                                        <div class="card-body">
                                            <p class="card-text communityAbout">' . $row["c_about"] . '</p>
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a role="button" class="btn btn-block mr-1 btn-outline-success communityChat" href="chat.php?id='.$row["c_id"].'">Chat Room</a>
