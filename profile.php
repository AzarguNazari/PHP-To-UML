<?php
    ...
    $uid = test_input($_GET['id']);
    
    $mainUser = false;
    
    $info = array();
    $info = getInfoById($uid);
                                ...
                                <div class="col-sm-6 col-md-4">
                                    ...
                                    <?php 
                                        ...
                                        function printLikedCommunities($row){
                                            $output = '<div class="alert alert-success alert-dismissible fade show m-1" role="alert" style="display:inline-block">
                                                    <strong><a href="chat.php?id=' . $row[0] . '">' . $row[1] . '</a></strong>';
                                            if($GLOBALS['mainUser']){
                                                $output .= '<button type="button" class="close" data-dismiss="alert" aria-label="Close" onclick="removeFavorite('.$row[0].')" >
